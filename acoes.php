    ...
    if($foto == "" or $nome == "" or $cpf =="" or $endereco == "" or $estado == "" or $data_nasc == "" or $sexo == "" or $senha == "" or $areas == ""){
        ...
        if($vali_cpf == true){            
            ...
            if($validate == false){
                ...
                $conexao->query("UPDATE clientes SET foto = '$nome_foto' , nome = '$nome', cpf = '$cpf', endereco = '$endereco', estado = '$estado', data_nasc = '$data_nasc', sexo = '$sexo', senha = '$senha', areas = '$areas'  WHERE id = $id");
                //INSERT INTO clientes SET foto = '$nome_foto' , nome = '$nome', cpf = '$cpf', endereco = '$endereco', estado = '$estado', data_nasc = '$data_nasc', sexo = '$sexo', senha = '$senha', areas = '$areas'
